...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/app/widget", label: "Widget", icon: "⬡" },
      { href: "/app/widget/preview", label: "Widget preview", icon: "◈" },
  ...
  {
    heading: "Reporting",
    items: [{ href: "/app/analytics", label: "Analytics", icon: "▣" }],
  },
  {
    heading: "Admin",
    items: [
      ...
      { href: "/app/help", label: "Help", icon: "H" },
    ],
  },
] as const;
