  ...
  return (
    <div className="space-y-8">
      ...
      <DashboardEmptyState
        ...
        description="No gateway or billing portal is wired in this build—nothing here charges cards or creates invoices. Use the sections below as a roadmap; today you can run checkout on your own site and use this product for questions and handoff."
        steps={[
          "Pick your gateway (Razorpay, Stripe, etc.) and whether you need pay-by-link in chat.",
