            ...
            description={
              <>
                ...
                <p className="mt-2 text-zinc-600 dark:text-zinc-400">
                  Use <strong className="font-medium text-zinc-800 dark:text-zinc-200">Team reply</strong> below to
                  message the customer in the same website widget thread (and on WhatsApp when a phone is on file). The
                  checklist covers follow-ups and knowledge.
                </p>
              </>
            }
            actions={
              ...
              {conversation.needsHuman ? (
                <>
                  <li>
                    ...
                    reply (widget + WhatsApp when configured), or externally if you prefer.
                    {ch === "whatsapp" && waLink ? (
                      <>
                        {" "}
                        <a
                  ...
                  <li>
                    <span className="font-medium text-zinc-900 dark:text-zinc-100">Log the outcome</span> under Leads or
                    your CRM so the team sees ownership.
                  </li>
                  <li>
