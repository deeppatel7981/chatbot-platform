    ...
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <DashboardEmptyState
          ...
          description="When your workspace has automation rows, you’ll toggle them here. Until then, focus on knowledge and channels so replies stay accurate."
          steps={[
            "Knowledge base — upload PDFs or text so the bot has real answers.",
