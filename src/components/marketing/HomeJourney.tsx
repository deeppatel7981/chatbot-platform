...
export default function HomeJourney() {
  ...
  return (
    <section className="mt-20 border-t border-zinc-200/80 pt-16 dark:border-zinc-800">
      <h2 className="text-center text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">
        Built around your customer use case
      </h2>
      <p className="mx-auto mt-2 max-w-2xl text-center text-sm text-zinc-600 dark:text-zinc-400">
        Pick a lens — operators, end users, or governance — and see how the product connects.
      </p>
      ...
      <div className="mt-10 overflow-hidden rounded-2xl border border-zinc-200/80 bg-white/90 shadow-xl dark:border-zinc-800 dark:bg-zinc-900/90">
        <div className="grid items-stretch gap-0 lg:grid-cols-2">
          <div className="relative flex min-h-[220px] flex-col justify-center p-8 sm:p-10">
