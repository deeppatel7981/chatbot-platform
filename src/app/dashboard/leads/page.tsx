      ...
      <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-dashboard-card dark:border-zinc-800 dark:bg-zinc-950">
        {loading ? (
          ...
          <div className="px-4 py-12 text-center">
            <p className="text-sm font-medium text-zinc-700 dark:text-zinc-300">No leads yet</p>
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              Create one above, or connect chats so leads can be captured from conversations.
            </p>
            <Link
